...
function processWriteup(writeup) {
    ...
    var toEditGroup = doc.layerSets.getByName('toEdit');
    var titleLayer = toEditGroup.layers.getByName('title');
    var writerLayer = toEditGroup.layers.getByName('writer');
